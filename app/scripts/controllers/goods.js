...
module.config(function($routeProvider) {
  ...
  module.controller('GoodsCtrl', function($location, $translate, $rootScope, $scope, $http, $routeParams, 
    nxt, plugins, shoppingCartService, AllGoodsProvider, PastGoodsProvider, GoodsDetailsProvider, UserGoodsProvider, 
